                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="password"
                        name="password"
                        v-model="dataOnePemandu.password"
                      />
                    ...
                    <div class="form-group">
                      ...
                      <div class="check-error">
                        <input
                          ...
                          v-model="dataOnePemandu.no_hp"
                        />
                        <small
                          :class="
                            `text-danger d-flex ${
                              validationEdit.no_hp.status === true
                                ? 'd-none'
                                : 'd-flex'
                            }`
                          "
                          >{{ validationEdit.no_hp.message }}</small
                        >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="check-error">
                        <select
                          name="gugus"
                          id="gugus"
                          v-model="dataOnePemandu.gugus_id"
                          class="form-select"
                        >
                    ...
                    <div class="form-group">
                      ...
                      <div class="check-error">
                        <input
                          ...
                          name="foto"
                          id="fotoEdit"
                          :data-default-file="dataOnePemandu.foto"
                          class="dropify"
                        />
                        <small
                          :class="
                            `text-danger d-flex ${
                              validationEdit.foto.status === true
                                ? 'd-none'
                                : 'd-flex'
                            }`
                          "
                          >{{ validationEdit.foto.message }}</small
                        >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="check-error">
                        <input
                          ...
                          class="form-control"
                          placeholder="Contoh: 08123456789"
                          v-model="tambah.no_hp"
                        />
                        <small
                          :class="
                            `text-danger d-flex ${
                              validationTambah.no_hp.status === true
                                ? 'd-none'
                                : 'd-flex'
                            }`
                          "
                          >{{ validationTambah.no_hp.message }}</small
                        >
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    editPemandu() {
      ...
      setTimeout(() => {
        if (
          this.dataOnePemandu.nama &&
          this.dataOnePemandu.email &&
          this.dataOnePemandu.no_hp &&
          this.dataOnePemandu.gugus_id &&
          passe === true &&
          this.dataOnePemandu.alamat
        ) {
          ...
          setTimeout(() => {
            axios
              .put(
                `${this.url}bemkm/superadmin/pemandu/${this.dataOnePemandu.uuid}`,
                this.dataOnePemandu,
                {
                  headers: {
                    Authorization: localStorage.token,
      ...
      if (!this.dataOnePemandu.gugus_id) {
        ...
        this.validationEdit.gugus_id.message = "Departemen harus dipilih!";
      } else {
    ...
    openEditPemandu(uuidPemandu) {
      ...
      axios
        .get(`${this.url}bemkm/superadmin/pemandu/${uuidPemandu}`, {
          headers: {
            Authorization: localStorage.token,
          },
        })
      ...
      Swal.fire({
        ...
        .then((result) => {
          ...
          if (result.isConfirmed) {
            axios
              .delete(`${this.url}bemkm/superadmin/pemandu/${uuidPemandu}`, {
                headers: {
                  Authorization: localStorage.token,
                },
              })
    ...
    tambahPemandu() {
      if (
        ...
        this.tambah.email &&
        this.tambah.no_hp &&
        this.tambah.gugus_id &&
        this.tambah.alamat &&
        document.getElementById("fotoTambah").files[0]
      ) {
        ...
        setTimeout(() => {
          axios
            .post(`${this.url}bemkm/superadmin/pemandu`, this.tambah, {
              headers: {
                Authorization: localStorage.token,
              },
            })
      ...
      if (!this.tambah.gugus_id) {
        ...
        this.validationTambah.gugus_id.message = "Departemen harus dipilih!";
      } else {
